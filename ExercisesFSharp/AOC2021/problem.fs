module ExercisesFSharp.AOC2021.problem
...
let ``day3 binary diagnostic`` file expected =
    ...
    let actual = Day3.binaryDiagnostic input
...
let ``day3 binary diagnostic part2`` file expected =
    ...
    let actual = Day3.binaryDiagnosticPart2 input
...
let ``day5 hydrothermal venture`` fileName expected =
    ...
    let actual = Day5.hydrothermalVenture input
...
let ``day5 hydrothermal venture part 2`` fileName expected =
    ...
    let actual = Day5.hydrothermalVenturePart2 input
